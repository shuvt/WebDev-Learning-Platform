            ...
            <nav class="toc-nav">
                <ul>
                    ...
                    <li><a href="#basic-php">2. ОСНОВЫ PHP</a>
                        <ul>
                            <li><a href="#intro-php">2.1. Введение в PHP</a></li>
                            <li><a href="#basic-syntax-php">2.2. Основы синтаксиса</a></li>
                            <li><a href="#work-with-data">2.3. Работа с данными</a></li>
                            <li><a href="#functions-and-OOP">2.4. Функции и ООП</a></li>
                            <li><a href="#work-with-files">2.5. Работа с файлами</a></li>
                            <li><a href="#php+sql">2.6. Связка PHP+SQL</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
                ...
                <article id="basic-syntax-php" class="lesson">
                    ...
                    <div class="text-content">
                        ...
                        <p>Нужны для пояснения логики, временного отключения кода или заметок для других разработчиков<br>
                            ...
                            Многострочные комментарии – Обрамляются /* и */
                        </p>
